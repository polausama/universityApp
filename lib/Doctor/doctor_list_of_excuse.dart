...
import 'doctor_specifiec_execuse.dart';


class DoctorListOfExcusesPage extends StatelessWidget {
  const DoctorListOfExcusesPage({Key? key}) : super(key: key);
  @override
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context,index){
                              ...
                              return GestureDetector(
                                onTap: (){
                                  Get.to(()=>DoctorSpecificExcuse(),arguments: ExcuseItem);
                                },
                                child: Container(
                                  height: 22.h,
