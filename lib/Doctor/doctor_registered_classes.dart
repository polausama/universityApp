...
import 'doctor_specific_class.dart';


class DoctorRegisteredClasses extends StatelessWidget {
  const DoctorRegisteredClasses({Key? key}) : super(key: key);
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: (){
                            Get.to(()=>DoctorSpecifiecClass(),arguments: registeredClass);
                          },
                          child: Container(
                            height: 12.h,
