...
import 'doctor_list_of_excuse.dart';
import 'doctor_list_of_students.dart';


class DoctorSpecifiecClass extends StatelessWidget {
  DoctorSpecifiecClass({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              Get.to(()=>DoctorListOfStudentsPage(),arguments:Class);
                            },
                            child: Container(
                              ...
                              child: Text(
                                "REGISTERED STUDENTS",style: TextStyle(
                                  fontSize: 10.sp,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold
                              ),
                          ...
                          GestureDetector(
                            onTap: (){
                              Get.to(()=>DoctorListOfExcusesPage(),arguments:Class);
                            },
                            child: Container(
                              width: 40.w,height: 10.h,
                              alignment: Alignment.center,
                      ...
                      GestureDetector(
                        onTap: (){
                          Get.to(()=>WriteExcusePage(),arguments:Class );
                        },
                        child: Container(width: 60.w,height: 10.h,
                          ...
                          child: Text(
                            "WRITE AN EXCUSE",style: TextStyle(
                              fontSize: 10.sp,
                              color: Colors.white,
                              fontWeight: FontWeight.bold
                          ),
