...
class RegisteredClasses extends StatelessWidget {
  const RegisteredClasses({Key? key}) : super(key: key);
      ...
      Align(
        ...
        child: Container(
          ...
          child: ListView.builder(
              itemCount: constantsVaribles.studentClasses.length!= null?
              constantsVaribles.studentClasses.length:0,
              itemBuilder: (context, index) {
                final registeredClass = constantsVaribles.studentClasses[index];
                return GestureDetector(
                  onTap: (){
                    Get.to(()=>SpecifiecClass(),arguments: registeredClass);
                  },
                  child: Container(
                    height: 12.h,
